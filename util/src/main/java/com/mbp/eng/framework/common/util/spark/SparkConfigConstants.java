package com.mbp.eng.framework.common.util.spark;

public class SparkConfigConstants {
    public static final String SPARK_MASTER_YARN = "yarn";
    ...
    public static final String SPARK_DEPLOYMODE = "spark.deployMode";
}
